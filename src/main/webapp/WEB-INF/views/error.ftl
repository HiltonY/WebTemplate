...
<body>
    <section class="m-content">
        ...
        <ul class="message">
            <#if error_msg??><li>${(error_msg)!''}, <a href="/index">返回首页</a></li></#if>
            <#if exception??><li style='color:red'>${(exception)!''}</#if>
            <#if !error_msg?? && !exception??><li>您访问了不存在的页面, <a href="/backend/index">返回首页</a></li></#if>
        </ul>
    </section>
