...
NEJ.define([
    ...
    '{pro}widget/datepick3/calendar.js',
    'util/template/tpl',
    'util/template/jst',
    'text!./datepick.css',
    'text!./datepick.html'
],function(NEJ,_k,_e,_v,_u,_i0,_t0,_t1,_t2,_css,_html,_p,_o,_f,_r){
    var _pro,
        _seed_html,
    ...
    _pro.__initNode = function(){
        ...
        var _button = _e._$getChildren(_list[3]);
        ...
        this.__copt.clean = _button[0];
        this.__copt.today = _button[1];
        _v._$addEvent(this.__copt.clean,'click',this.__destroyWin._$bind(this));
        _v._$addEvent(this.__copt.today,'click',this.__changeToday._$bind(this));
    };
    /*
    *今天
    */
   _pro.__changeToday = function(){
        var todayNum = new Date();
        this._$setDate(todayNum);
   };
    /*
    *清除
    */
    _pro.__destroyWin = function(){
        var cleandate = null;
        this._$dispatchEvent('onchange',cleandate);
        this.__destroy();
        this._$hide();
