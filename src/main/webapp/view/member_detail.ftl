            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <div class="input-group date">
                        ...
                        <input type="text" class="form-control pull-right" value="${member.birthday?date}" id="datepicker" placeholder="点击输入 ..." disabled>
                    </div>
                </div>
                <div class="col-lg-6">
                    <label class="col-lg-12">联系电话</label>
                    <input id="phoneNumber" type="text" class="form-control" value="${member.phoneNumber}" placeholder="点击输入 ..." disabled>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
