...
<#--<#list 0..(trackhistory?size-1)/2 as t>-->
    ...
    <#list locationInTime?keys as key>
                            ...
                            <div class="col-md-8">
                                <div class="box-body no-padding">
                                    <div style="width:100%; height:400px;background:url(/img/map.jpg);background-size:100% 100%; ">
                                        ...
                                        <#assign item = locationInTime[key]>
                                            ...
                                            <#--</div>-->
                                                <img class="point"
                                                    ...
                                                    <#--预警-->
                                                     ...
                                                     onclick="clickPositionPoint(this,${key},${location.xPosition},${location.yPosition},'${location.sampleTime?string("yyyy-MM-dd HH:mm:ss")}',${location.status},'${location.memberName}') ">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tr>
                                            <th style="width:50%">客户姓名</th>
                                            <td id="memberName${key}"></td>
                                        </tr>
                                        <tr>
                                            <th>监控时间</th>
                                            <td id="time${key}"></td>
